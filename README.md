...
- DCC versus ADCC comparisons do **not** provide strong evidence that an asymmetric correlation term materially improves fit for the four tested systems; AIC and BIC favor the simpler DCC specification in the saved comparison.
...
The analysis distinguishes three evidentiary layers:
...
3. **Prediction** — evaluated separately with time-ordered validation; negative out-of-sample R² means the current evidence does not support a forecasting claim.

## Repository map

- [`SPECIFICATION.md`](SPECIFICATION.md) — frozen estimand, variables, transforms, horizons, inference rules, and claim discipline.
